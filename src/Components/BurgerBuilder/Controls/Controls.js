...
const BuildControl = props => {
    return (
        <div className="d-flex">
            <div className="mr-auto ml-5" style={{ fontWeight: "bold", marginRight: "auto", fontSize: "1.2rem" }}>{props.label}</div>
    ...
    return (
        <div className="container ml-md-5" style={{ textAlign: "center" }}>
            <Card style={{
                ...
                <Button style={{ background: "#D70F64" }} disabled={!props.purchasable} onClick={props.toggleModal} >Order Now</Button>
            </Card>
        </div>
    );
};
